...
var exitTriggerSchema = new mongoose.Schema({ variety: String, order_id: String, tradingsymbol: String, trigger_price: String, transaction_type: String, status: String })
var ExitTrigger = mongoose.model('ExitTrigger', exitTriggerSchema)

var orderTriggerSchema = new mongoose.Schema({ variety: String, params: String, trigger_price: String, transaction_type: String, status: String })
